...
This guide is to demonstrate the functions of **waferscopeR** and document the internal datasets for exploration.
...
Each wafer cab be accessed by index within the list or slot number such as "slot1". The dat structure contains layer thickness, good of fit (GOF) and (x,y) coordinates of measurement within a wafer.
...
- maps = "decompose" all the radial and residual maps: a good way to visualize symmetric vs assymetric components
